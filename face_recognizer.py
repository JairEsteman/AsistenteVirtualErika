...
data_path = 'D:\\Desarrollo_Python\\Erika\\Data_Face'
image_paths = os.listdir(data_path)
# print('image_paths=', image_paths)
face_recognizer = cv2.face.LBPHFaceRecognizer_create()
# Leyendo el modelo
face_recognizer.read('D:\\Desarrollo_Python\\Erika\\LBPHFaceModel.xml')


face_classif = cv2.CascadeClassifier('D:\\Desarrollo_Python\\Erika\\haarcascade_frontalface_default.xml')
